...
export default function CurrencyPage() {
  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900' : 'bg-gray-50'} p-4 md:p-8`}>
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">
            أسعار صرف العملات
          </h1>
          <div className="flex items-center px-3 py-1 rounded-full bg-white dark:bg-gray-800 shadow">
            <span className={`text-sm mr-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              {darkMode ? 'الوضع الليلي' : 'الوضع النهاري'}
            </span>
            <div 
              className={`w-12 h-6 rounded-full p-1 cursor-pointer ${darkMode ? 'bg-blue-600' : 'bg-gray-200'}`}
        ...
        <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8 transition-all duration-300 ${
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4 items-end">
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <input
                  type="text"
                  className="w-full p-3 pl-12 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
                  value={baseAmount}
            ...
            <div className="md:col-span-2">
              ...
              <div className="relative">
                <select
                  className="w-full p-3 pr-10 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200 appearance-none"
                  value={baseCurrency}
            ...
            <div className="flex items-center justify-center">
              <button
                onClick={handleSwap}
                className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300 transform hover:rotate-180"
          ...
          <div className="mt-6 p-5 rounded-lg bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 border border-blue-200 dark:border-blue-800/50">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-4">
            ...
            <div className="relative w-64">
              ...
              <input
                type="text"
                className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-800 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200"
        ...
        <div className="text-center text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700 pt-6">
          <p>تم التطوير باستخدام Next.js و React Icons</p>
          <p className="mt-1">الأسعار يتم تحديثها كل 5 دقائق</p>
        </div>
      </div>
    </div>
  );
