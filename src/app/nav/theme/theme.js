  ...
  return {
    ...
    palette: {
      ...
      ...(isLight ? {
        ...
        background: {
          default: '#f8f9fa', // Slightly lighter background for better contrast
          paper: '#ffffff',
          defaultChannel: '248 249 250', // For better compatibility with MUI components
        ...
        // Add more contrast for specific elements
